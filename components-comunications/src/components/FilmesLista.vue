...
import FilmesListaItenEditar from "@/components/FilmesListaItenEditar";
...
export default {
  ...
  data() {
    return {
      filmes: [
        ...
        {id:4, titulo: 'Homem de Ferro', ano: 2018, diretor: 'Stan Lee'}
      ],
  ...
  methods: {
    ...
    atualizarFilme(filmeAtualizado) {
      const ind = this.filmes.findIndex(filme => filme.id === filmeAtualizado.id)
      this.filmes.splice(ind, 1, filmeAtualizado)
